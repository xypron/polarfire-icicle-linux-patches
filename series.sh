...
git reset --hard v5.18.17

git am ../0001-hwrng-mpfs-add-polarfire-soc-hwrng-support.patch
git am ../0001-hwrng-mpfs-Enable-COMPILE_TEST.patch
...
git am ../0001-MAINTAINERS-add-polarfire-rng-pci-and-clock-drivers.patch
